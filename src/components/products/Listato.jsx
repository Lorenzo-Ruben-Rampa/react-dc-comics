...
export default function Listato() {

    // Array dei fumetti copiato da comics.js
    const comics = [
        {
            id: 1,
        ...
        },
        {
            ...
            thumb: "https://mycomics.it/wp-content/uploads/sites/16/2022/09/FUMBATPAN0056.jpg",
            price: "$3.99",
            series: "Batman",
    ...
    function renderComics() {
        return comics.map(comic => <Card key={comic.id} comicSrc={comic.thumb} comicTitle={comic.series} />)
    }
